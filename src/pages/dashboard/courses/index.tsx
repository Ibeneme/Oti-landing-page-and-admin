        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-4 md:p-6">
          <>
            ...
            <Link
              ...
              className="w-full cursor-pointer hover:bg-primary transition-all hover:scale-105 hover:text-white border border-border rounded-lg p-4 flex flex-col items-center justify-center text-center"
            >
              <div className="text-6xl font-bold mb-4">+</div>
              <h3 className="text-xl font-bold">Create a Course</h3>
              <p className="text-sm text-muted-foreground mt-2">
                Create a course to share your knowledge with the world.
              </p>
            </Link>
          </>
        </section>
