...
const LineChart: React.FC<{ latest: number }> = ({ latest }) => {
  ...
  const generateDateRange = (period: "Day" | "Week" | "Month") => {
    ...
    return { startDate: dates[0], data };
  };

  // const updateChartData = (period: 'Day' | 'Week' | 'Month') => {
  //   const { dates, data } = generateDateRange(period);
  //   setState({
  //     series: [
  //       {
  //         name: "User Growth",
        ...
        <div className="flex w-full flex-wrap gap-3 sm:gap-5">
          <div className="flex min-w-47.5">
            ...
            <div className="w-full">
              <p className="font-semibold text-white">Users Growth</p>
              <p className="text-sm font-medium">
                {generateDateRange(selected).startDate} -{" "}
